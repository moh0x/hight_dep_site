  ...
  async function click(e) {
    ...
    return(
        <section className="mx-auto login-container" style={{display:"flex",height:"90vh",justifyContent:"center",alignItems:"center"}}>
                      ...
                      {load ? <div className='text-center'><FourSquare color="#3bc5f3" size="medium" text="" textColor="" /></div>: <h2 className="text-white col btn btn-primary fw-bold p-2" onClick={(e)=>click(e)}>Add Admin</h2>}

...
function AddCourse() {
  const params = useParams()
        ...
        async function click(e) {
            if (formData.matricule.length < 1 || formData.matricule.length < 10 || formData.Depart.length < 3 || formData.Depart.length > 50 || formData.Destination.length < 3 || formData.Destination.length > 50 || formData.marque.length < 3 || formData.marque.length > 50 ) {

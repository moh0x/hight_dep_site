...
function PaymentItem(props) {
       ...
       <td scope="col">{props.payment._id}</td>
            ...
            <td scope="col">{props.payment.earnedOfCourses} DA</td>
            <td scope="col">{props.payment.cash} DA</td>
        <td scope="col">{props.payment.payFromCompany} DA</td>
           <td scope="col">{props.payment.commision} %</td>

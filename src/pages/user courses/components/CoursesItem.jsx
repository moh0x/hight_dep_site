...
function CourseItem(props) {
       ...
       <td scope="col">{props.course._id}</td>
          ...
          {props.course.isFinished ?   <td scope="col">{props.course.priceParKilomitre}</td>: <td scope="col"><div className="bg-danger p-1 rounded">Not Yet!</div></td>}   
            ...
            {props.course.isFinished == true ?       <td scope="col"><img width={150} height={150} style={{borderRadius:"15px",textDecoration:"none"}} src={`${props.course.cartGris}`}></img></td>: <td scope="col">Not Yet!</td>}       

...
function CoursesBody(props) {
    return ( props.courses.length == 0?<div className="text-white text-center" style={{fontWeight:"bold",fontSize:"20px",height:"75vh",display:"flex",alignItems:"center",justifyContent:"center"}}>There Is No Tripes For This User !</div>: 
...
console.log(course.assurance);
        ...
        <div class="card-body">
          ...
          <h6 className="col"style={{marginBottom:"10px"}}>Price(1 Km) :{course.isFinished == true ? course.priceParKilomitre:<div className="bg-danger p-1 rounded" style={{width:"fit-content",display:"inline"}}>Not Yet!</div>} {course.isFinished == true ? <>Da</>:<></>}</h6>
          ...
          <h6 className="col"style={{marginBottom:"10px"}}>Assurance : {course.isFinished == true && course.assurance != null && course.assurance != undefined  ? course.assurance : <div className="bg-danger p-1 rounded" style={{width:"fit-content",display:"inline"}}>Not Yet!</div>}</h6>
          <h6 className="col"style={{marginBottom:"10px"}}>Date(end) : {course.isFinished == true ? course.dateEndJourney.toString().substring(0,10):<div className="bg-danger p-1 rounded" style={{width:"fit-content",display:"inline"}}>Not Yet!</div>}</h6>
          <h6 className="col"style={{marginBottom:"10px"}}>Gray Card : {course.isFinished == true ? <a href={course.cartGris}>Gray Card</a> : <div className="bg-danger p-1 rounded" style={{width:"fit-content",display:"inline"}}>Not Yet!</div>}</h6>
          <h6 style={{marginBottom:"10px"}}>Payment : {course.isFinished == true ? course.isPay == true ?   <div className="bg-danger p-1 rounded" style={{width:"fit-content",display:"inline"}}>Paid</div>: <div className="bg-danger p-1 rounded" style={{width:"fit-content",display:"inline"}}>Pending!</div> : <div className="bg-danger p-1 rounded" style={{width:"fit-content",display:"inline"}}>Not Yet!</div>}</h6>
            <h6 style={{marginBottom:"10px"}}>Status : {course.isAccept == true ? course.isFinished == false?<div style={{width:"fit-content",display:"inline"}} className="bg-primary p-1 rounded">Driving!</div>:  <div className="bg-success p-1 rounded" style={{width:"fit-content",display:"inline"}}>Finish</div>:<div className="bg-warning p-1 rounded" style={{width:"fit-content",display:"inline"}}>Sent to driver!</div>}</h6>

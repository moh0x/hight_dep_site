...
function PaymentsBody(props) {
    return (
    props.payments.length == 0 ? <div className="text-white text-center" style={{fontWeight:"bold",fontSize:"20px",height:"75vh",display:"flex",alignItems:"center",justifyContent:"center"}}>There Is No Payments !</div>:<div className="table-responsive custom-scrollbar" style={{overflowX: "auto", overFlowY: "hidden",}}>
